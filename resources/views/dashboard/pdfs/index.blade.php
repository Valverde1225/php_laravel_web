...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <div class="row col-12">
      <div class="col-6">
        <h6 class="m-0 font-weight-bold text-primary btn-icon-split align-bottom">Exportar PDF por Observaciones</h6>
      </div>
      <div class="col-6">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    <label>URL</label>
                    <input type="text" class="form-control" name="url" id='url' placeholder="Ej: https://www.agrino.cl"/>
                </div>
            </div>
        </div>
        <div class="form-group">
