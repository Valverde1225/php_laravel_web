...
?>
<div class="col-6">
        <h4 class="m-0 font-weight-bold text-primary btn-icon-split align-bottom">Gráfico Historico Litros/Hora</h4>
      </div><br/>
...
<select class="form-control" name="chipinfo_sector">
  ...
  <br/>
  <input class="form-control" type="date" name="fechainfo_sector">
  <br/>
