            ...
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">
                  <img src="/img/logo.png" class="responsive-img" style="max-width: 100%; height: auto; ">
                </h1>
              </div>
              <form method="POST" action="{{ route('login') }}" class="user" id="formLogin">
                {{ csrf_field() }}
                <div class="form-group">
                  <input type="email" name="email" class="form-control form-control-user" placeholder="Ingresa tú E-mail ...">
                </div>
                <div class="form-group">
