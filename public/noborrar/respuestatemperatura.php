...
function temperatura_ambiente_diaria ($chipinfo_sector,$ano,$mes,$dia) {
 ...
 $resultado=pg_query("SELECT extract(epoch FROM fechainfo_sector), sen_t_aminfo_sector FROM info_sectores WHERE date_part('year',fechainfo_sector) = ".$ano." AND date_part('month',fechainfo_sector) = ".$mes." AND date_part('day',fechainfo_sector) = ".$dia." AND chipinfo_sector = '$chipinfo_sector'");
...
title: {
    text: 'Temperatura Ambiente del dia:'
},

subtitle: {
    text: 'Gráfico Temperatura Ambiente'
},
...
series: [{
    name: 'Temperatura',
            data: [<?php
                ...
                temperatura_ambiente_diaria($chipinfo_sector, $ano , $mes, $dia);
             ?>]
}],
